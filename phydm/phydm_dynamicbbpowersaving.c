...
static inline void phydm_update_rf_state(struct phy_dm_struct *dm,
					 struct dyn_pwr_saving *p_dm_ps_table,
					 int _rssi_up_bound,
					 int _rssi_low_bound,
...
void odm_dynamic_bb_power_saving_init(void *dm_void)
{
	...
	struct dyn_pwr_saving *p_dm_ps_table = &dm->dm_ps_table;
