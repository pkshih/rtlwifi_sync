...
halmac_mount_api_88xx(struct halmac_adapter *halmac_adapter)
{
	...
	PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_INIT, HALMAC_DBG_ERR,
			   HALMAC_SVN_VER_88XX "\n");
	PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_INIT, HALMAC_DBG_ERR,
	...
	if (halmac_adapter->halmac_interface == HALMAC_INTERFACE_SDIO) {
		...
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_INIT,
				   HALMAC_DBG_ERR,
	...
	if (halmac_adapter->chip_id == HALMAC_CHIP_ID_8822B) {
		...
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_INIT,
				   HALMAC_DBG_ERR, "Chip ID undefine!!\n");
			      ...
			      u8 *hamacl_fw, u32 halmac_fw_size)
{
	...
	PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_INIT, HALMAC_DBG_TRACE,
				   ...
				   u32 halmac_fw_size)
{
	...
	if (halmac_fw_size > HALMAC_FW_SIZE_MAX_88XX ||
	    halmac_fw_size < HALMAC_FWHDR_SIZE_88XX) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_INIT,
				   HALMAC_DBG_ERR, "[ERR]FW size error!\n");
		return HALMAC_RET_FW_SIZE_ERR;
	}
			 ...
			 union halmac_wlan_addr *hal_address)
{
	...
	if (halmac_port >= HALMAC_PORTIDMAX) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_INIT,
				   HALMAC_DBG_ERR, "[ERR]port index > 5\n");
			 ...
			 enum halmac_trx_mode mode)
{
	...
	if (status != HALMAC_RET_SUCCESS) {
		PLATFORM_MSG_PRINT(
			driver_adapter, HALMAC_MSG_INIT, HALMAC_DBG_ERR,
			   ...
			   enum halmac_efuse_read_cfg cfg)
{
	...
	if (halmac_adapter->halmac_state.mac_power == HALMAC_MAC_POWER_OFF)
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_EFUSE,
				   HALMAC_DBG_WARN,
	...
	*process_status = HALMAC_CMD_PROCESS_IDLE;
	...
	if (status != HALMAC_RET_SUCCESS) {
		PLATFORM_MSG_PRINT(
			driver_adapter, HALMAC_MSG_EFUSE, HALMAC_DBG_ERR,
	...
	PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_EFUSE, HALMAC_DBG_TRACE,
			      ...
			      u32 bt_efuse_map_size, u8 *bt_efuse_map)
{
	...
	if ((halmac_efuse_bank >= HALMAC_EFUSE_BANK_MAX) ||
		...
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_EFUSE,
				   HALMAC_DBG_ERR, "Undefined BT bank\n");
			   ...
			   enum halmac_efuse_bank halmac_efuse_bank)
{
	...
	if (halmac_offset >= halmac_adapter->hw_config_info.efuse_size) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_EFUSE,
				   HALMAC_DBG_ERR, "Offset is too large\n");
		return HALMAC_RET_EFUSE_SIZE_INCORRECT;
	}
				     ...
				     u32 *halmac_size)
{
	...
	PLATFORM_MSG_PRINT(
		driver_adapter, HALMAC_MSG_EFUSE, HALMAC_DBG_TRACE,
		"halmac_get_efuse_available_size_88xx ==========>\n");
				   ...
				   enum halmac_efuse_read_cfg cfg)
{
	...
	if (halmac_adapter->halmac_state.mac_power == HALMAC_MAC_POWER_OFF)
		PLATFORM_MSG_PRINT(
			driver_adapter, HALMAC_MSG_EFUSE, HALMAC_DBG_WARN,
			    ...
			    enum halmac_efuse_read_cfg cfg)
{
	...
	if (!pg_efuse_info->efuse_map) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_EFUSE,
				   HALMAC_DBG_ERR, "efuse_map is NULL\n");
		return HALMAC_RET_NULL_POINTER;
	}

	if (!pg_efuse_info->efuse_mask) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_EFUSE,
				   HALMAC_DBG_ERR, "efuse_mask is NULL\n");
		return HALMAC_RET_NULL_POINTER;
	}
			 ...
			 u32 halmac_size)
{
	...
	if (GET_RX_DESC_C2H(halmac_buf)) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_H2C,
				   HALMAC_DBG_TRACE,
			     ...
			     struct halmac_fwlps_option *lps_option)
{
	...
	PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_PWR, HALMAC_DBG_TRACE,
		     ...
		     enum halmac_ps_state ps_state)
{
	...
	if (ps_state == halmac_adapter->halmac_state.ps_state) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_PWR,
				   HALMAC_DBG_ERR,
	...
	if (ps_state == HALMAC_PS_STATE_LPS) {
		...
		if (status != HALMAC_RET_SUCCESS) {
			PLATFORM_MSG_PRINT(
				driver_adapter, HALMAC_MSG_PWR, HALMAC_DBG_ERR,
...
enum halmac_ret_status halmac_h2c_lb_88xx(struct halmac_adapter *halmac_adapter)
{
	...
	PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_H2C, HALMAC_DBG_TRACE,
			   "halmac_h2c_lb_88xx ==========>\n");
			  ...
			  u8 full_fifo)
{
	...
	if (halmac_adapter->halmac_state.dlfw_state == HALMAC_DLFW_NONE) {
		PLATFORM_MSG_PRINT(
			driver_adapter, HALMAC_MSG_H2C, HALMAC_DBG_ERR,
		     ...
		     enum halmac_bw bw, u8 txbf_en)
{
	...
	if (txbf_en) {
		...
		default:
			PLATFORM_MSG_PRINT(
				driver_adapter, HALMAC_MSG_SND, HALMAC_DBG_ERR,
	...
	PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_SND, HALMAC_DBG_TRACE,
			 ...
			 enum halmac_data_rate datarate)
{
	...
	case HAL_BFEE:
		...
		break;
	default:
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_SND,
				   HALMAC_DBG_ERR,
			   ...
			   struct halmac_ch_switch_option *cs_option)
{
	...
	PLATFORM_MSG_PRINT(
		driver_adapter, HALMAC_MSG_H2C, HALMAC_DBG_TRACE,
		      ...
		      struct halmac_iqk_para_ *iqk_para)
{
	...
	if (*process_status == HALMAC_CMD_PROCESS_SENDING) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_INIT,
				   HALMAC_DBG_TRACE, "Wait event(iqk)...\n");
		return HALMAC_RET_BUSY_STATE;
	}
...
halmac_cfg_max_dl_size_88xx(struct halmac_adapter *halmac_adapter, u32 size)
{
	...
	PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_FW, HALMAC_DBG_TRACE,
			   "halmac_cfg_max_dl_size_88xx ==========>\n");

	if (size > HALMAC_FW_CFG_MAX_DL_SIZE_MAX_88XX) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_FW,
				   HALMAC_DBG_ERR,
	...
	if ((size & (2 - 1)) != 0) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_FW,
				   HALMAC_DBG_ERR, "size is not power of 2!\n");
		return HALMAC_RET_CFG_DLFW_SIZE_FAIL;
	}
				       ...
				       u16 start_psd, u16 end_psd)
{
	...
	if (*process_status == HALMAC_CMD_PROCESS_SENDING) {
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_INIT,
				   HALMAC_DBG_TRACE, "Wait event(psd)...\n");
		return HALMAC_RET_BUSY_STATE;
	}
			    ...
			    struct halmac_security_setting *sec_setting)
{
	...
	PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_COMMON, HALMAC_DBG_TRACE,
		      ...
		      struct halmac_cam_entry_info *cam_entry_info)
{
	...
	for (i = 0; i < 8; i++) {
		...
		PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_COMMON,
				   HALMAC_DBG_TRACE,
	...
	if (cam_entry_info->security_type == HAL_SECURITY_TYPE_WAPI ||
		...
		for (i = 0; i < 8; i++) {
			...
			PLATFORM_MSG_PRINT(driver_adapter, HALMAC_MSG_COMMON,
					   ...
					   *((u32 *)cam_entry_format + i));
			PLATFORM_MSG_PRINT(
				driver_adapter, HALMAC_MSG_COMMON,
				HALMAC_DBG_TRACE,
