...
#define PLATFORM_MSG_PRINT halmac_adapter->halmac_platform_api->MSG_PRINT
...
struct halmac_platform_api {
	...
	bool (*MSG_PRINT)(void *driver_adapter, u32 msg_type, u8 msg_level,
			  s8 *fmt, ...);
	bool (*BUFF_PRINT)(void *driver_adapter, u32 msg_type, u8 msg_level,
			   s8 *buf, u32 size);
