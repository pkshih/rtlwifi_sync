...
u32 glcoex_ver_date_8822b_2ant = 20161116;
u32 glcoex_ver_8822b_2ant = 0x3d;
...
u8 halbtc8822b2ant_wifi_rssi_state(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_coex_switch_threshold(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_limited_rx(struct btc_coexist *btcoexist, bool force_exec,
...
void halbtc8822b2ant_query_bt_info(struct btc_coexist *btcoexist)
{
	u8 h2c_parameter[1] = {0};
	bool RTL97F_8822B = false;

	if (true == RTL97F_8822B)
		return;
...
void halbtc8822b2ant_monitor_bt_ctr(struct btc_coexist *btcoexist)
{
...
void halbtc8822b2ant_monitor_wifi_ctr(struct btc_coexist *btcoexist) {}

bool halbtc8822b2ant_is_wifibt_status_changed(struct btc_coexist *btcoexist)
{
...
void halbtc8822b2ant_update_bt_link_info(struct btc_coexist *btcoexist)
{
	struct btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
	bool bt_hs_on = false;
	bool bt_busy = false;
	...
	if (!(coex_sta->bt_info & BT_INFO_8822B_2ANT_B_CONNECTION)) {
		...
		BTC_PRINTF("[BTCoex], BtInfoNotify(), BT ACL SCO busy!!!\n");
	} else if ((coex_sta->bt_info & BT_INFO_8822B_2ANT_B_SCO_ESCO) ||
		   (coex_sta->bt_info & BT_INFO_8822B_2ANT_B_SCO_BUSY)) {
...
void halbtc8822b2ant_update_wifi_channel_info(struct btc_coexist *btcoexist,
					      u8 type)
{
...
void halbtc8822b2ant_set_fw_dac_swing_level(struct btc_coexist *btcoexist,
					    u8 dac_swing_lvl)
{
	u8 h2c_parameter[1] = {0};
	u32 RTL97F_8822B = 0;
...
void halbtc8822b2ant_fw_dac_swing_lvl(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_set_fw_dec_bt_pwr(struct btc_coexist *btcoexist,
				       u8 dec_bt_pwr_lvl)
{
	u32 RTL97F_8822B = 0;
	u8 h2c_parameter[1] = {0};
...
void halbtc8822b2ant_dec_bt_pwr(struct btc_coexist *btcoexist, bool force_exec,
				u8 dec_bt_pwr_lvl)
{
...
void halbtc8822b2ant_low_penalty_ra(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_set_bt_auto_report(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_bt_auto_report(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_write_score_board(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_read_score_board(struct btc_coexist *btcoexist,
				      u16 *score_board_val)
{
	*score_board_val =
...
void halbtc8822b2ant_post_state_to_bt(struct btc_coexist *btcoexist, u16 type,
				      bool state)
{
	halbtc8822b2ant_write_score_board(btcoexist, (u16)type, state);
}

void halbtc8822b2ant_monitor_bt_enable_disable(struct btc_coexist *btcoexist)
{
...
void halbtc8822b2ant_enable_gnt_to_gpio(struct btc_coexist *btcoexist,
					bool isenable)
{
	...
	if (isenable) {
		BTC_PRINTF("[BTCoex], enable_gnt_to_gpio!!\n");
		...
		BTC_PRINTF("[BTCoex], disable_gnt_to_gpio!!\n");
...
u32 halbtc8822b2ant_ltecoex_indirect_read_reg(struct btc_coexist *btcoexist,
					      u16 reg_addr)
{
	u32 j = 0;
...
void halbtc8822b2ant_ltecoex_indirect_write_reg(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_ltecoex_enable(struct btc_coexist *btcoexist, bool enable)
{
	u8 val;
...
void halbtc8822b2ant_ltecoex_pathcontrol_owner(struct btc_coexist *btcoexist,
					       bool wifi_control)
{
	u8 val;
...
void halbtc8822b2ant_ltecoex_set_gnt_bt(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_ltecoex_set_gnt_wl(struct btc_coexist *btcoexist,
					u8 control_block, bool sw_control,
					u8 state)
{
	u32 val = 0, bit_mask;
...
void halbtc8822b2ant_ltecoex_set_coex_table(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_ltecoex_set_break_table(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_set_coex_table(struct btc_coexist *btcoexist, u32 val0x6c0,
...
void halbtc8822b2ant_coex_table(struct btc_coexist *btcoexist, bool force_exec,
...
void halbtc8822b2ant_coex_table_with_type(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_set_fw_ignore_wlan_act(struct btc_coexist *btcoexist,
					    bool enable)
{
	u8 h2c_parameter[1] = {0};
	u32 RTL97F_8822B = 0;
...
void halbtc8822b2ant_ignore_wlan_act(struct btc_coexist *btcoexist,
...
void halbtc8822b2ant_set_lps_rpwm(struct btc_coexist *btcoexist, u8 lps_val,
				  u8 rpwm_val)
{
	u8 lps = lps_val;
	u8 rpwm = rpwm_val;
...
void halbtc8822b2ant_lps_rpwm(struct btc_coexist *btcoexist, bool force_exec,
...
void halbtc8822b2ant_power_save_state(struct btc_coexist *btcoexist, u8 ps_type,
				      u8 lps_val, u8 rpwm_val)
{
...
void halbtc8822b2ant_set_fw_pstdma(struct btc_coexist *btcoexist, u8 byte1,
				   u8 byte2, u8 byte3, u8 byte4, u8 byte5)
{
	...
	if (ap_enable) {
		if (byte1 & BIT(4) && !(byte1 & BIT(5))) {
			BTC_PRINTF("[BTCoex], FW for AP mode\n");
			real_byte1 &= ~BIT(4);
			real_byte1 |= BIT(5);
...
void halbtc8822b2ant_ps_tdma(struct btc_coexist *btcoexist, bool force_exec,
...
void halbtc8822b2ant_set_ext_band_switch(struct btc_coexist *btcoexist,
					 bool force_exec, u8 pos_type)
{
}

/*anttenna control by bb mac bt antdiv pta to write 0x4c 0xcb4,0xcbd*/
void halbtc8822b2ant_set_ext_ant_switch(struct btc_coexist *btcoexist,
...
*/
	...
	case BT_8822B_2ANT_EXT_ANT_SWITCH_CTRL_BY_PTA:
		...
		regval_0xcbc =
			(switch_polatiry_inverse == false ?
				 0x2 :
				 0x1); /* 0xcb4[29:28] = 2b'10 for no switch_polatiry_inverse, DPDT_SEL_N =1, DPDT_SEL_P =0  @ GNT_BT=1 */
...
void halbtc8822b2ant_set_rfe_type(struct btc_coexist *btcoexist)
{
	struct btc_board_info *board_info = &btcoexist->board_info;
...
void halbtc8822b2ant_set_ant_path(struct btc_coexist *btcoexist,
...
u8 halbtc8822b2ant_action_algorithm(struct btc_coexist *btcoexist)
{
	struct btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
	bool bt_hs_on = false;
	...
	if (num_of_diff_profile == 0) {
		...
		if (bt_link_info->sco_exist) {
			if (bt_link_info->hid_exist) {
				BTC_PRINTF("[BTCoex], SCO + HID\n");
				algorithm = BT_8822B_2ANT_COEX_ALGO_SCO;
			} else if (bt_link_info->a2dp_exist) {
				BTC_PRINTF("[BTCoex], SCO + A2DP ==> A2DP\n");
				algorithm = BT_8822B_2ANT_COEX_ALGO_A2DP;
			} else if (bt_link_info->pan_exist) {
				if (bt_hs_on) {
					BTC_PRINTF("[BTCoex], SCO + PAN(HS)\n");
					algorithm = BT_8822B_2ANT_COEX_ALGO_SCO;
				} else {
					BTC_PRINTF(
						"[BTCoex], SCO + PAN(EDR)\n");
...
void halbtc8822b2ant_action_coex_all_off(struct btc_coexist *btcoexist)
{
...
void halbtc8822b2ant_action_wifi_under5g(struct btc_coexist *btcoexist)
{
	/* fw all off */
	BTC_PRINTF("[BTCoex], ************* under5g *************\n");
	halbtc8822b2ant_ps_tdma(btcoexist, NORMAL_EXEC, false, 0);
	halbtc8822b2ant_coex_table_with_type(btcoexist, NORMAL_EXEC, 0);
...
void halbtc8822b2ant_action_bt_inquiry(struct btc_coexist *btcoexist)
{
	bool wifi_connected = false;
	...
	if (link || roam || coex_sta->wifi_is_high_pri_task) {
		...
		BTC_PRINTF("[BTCoex], Wifi scan process + BT Inq/Page!!\n");
		...
		BTC_PRINTF("[BTCoex], Wifi connected + BT Inq/Page!!\n");
		...
		BTC_PRINTF("[BTCoex], Wifi no-link + BT Inq/Page!!\n");
...
void halbtc8822b2ant_action_wifi_link_process(struct btc_coexist *btcoexist)
{
	struct btc_bt_link_info *bt_link_info = &btcoexist->bt_link_info;
...
void halbtc8822b2ant_action_wifi_nonconnected(struct btc_coexist *btcoexist)
{
	halbtc8822b2ant_coex_table_with_type(btcoexist, NORMAL_EXEC, 0);
	halbtc8822b2ant_set_ant_path(btcoexist, BTC_ANT_PATH_AUTO, NORMAL_EXEC,
				     BT_8822B_2ANT_PHASE_2G_RUNTIME_CONCURRENT);
...
void halbtc8822b2ant_action_bt_idle(struct btc_coexist *btcoexist)
{
	...
	bt_rssi_state = halbtc8822b2ant_bt_rssi_state(
		&pre_bt_rssi_state, 2, coex_sta->bt_coex_thres, 0);

	bt_rssi_state2 = halbtc8822b2ant_bt_rssi_state(
		&pre_bt_rssi_state2, 2, coex_sta->bt_coex_thres2, 0);
	...
	if (scan || link || roam) {
		BTC_PRINTF("[BTCoex], Wifi link process + BT Idle!!\n");

		halbtc8822b2ant_coex_table_with_type(btcoexist, NORMAL_EXEC, 7);

		halbtc8822b2ant_ps_tdma(btcoexist, NORMAL_EXEC, true, 11);
	} else if (wifi_connected) {
		BTC_PRINTF("[BTCoex], Wifi connected + BT Idle!!\n");
		...
		BTC_PRINTF("[BTCoex], Wifi no-link + BT Idle!!\n");
...
void halbtc8822b2ant_action_sco(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
...
void halbtc8822b2ant_action_hid(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
...
void halbtc8822b2ant_action_a2dp(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
	...
	BTC_PRINTF("############# [BTCoex],  scan_ap_num = %d\n",
		   coex_sta->scan_ap_num);
...
void halbtc8822b2ant_action_pan_edr(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
...
/* PAN(HS) only */
void halbtc8822b2ant_action_pan_hs(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
...
void halbtc8822b2ant_action_hid_a2dp(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
...
void halbtc8822b2ant_action_a2dp_pan_hs(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
...
/* PAN(EDR)+A2DP */
void halbtc8822b2ant_action_pan_edr_a2dp(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
...
void halbtc8822b2ant_action_pan_edr_hid(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
...
/* HID+A2DP+PAN(EDR) */
void halbtc8822b2ant_action_hid_a2dp_pan_edr(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
	u8 wifi_rssi_state, bt_rssi_state;
...
void halbtc8822b2ant_action_bt_whck_test(struct btc_coexist *btcoexist)
{
	halbtc8822b2ant_fw_dac_swing_lvl(btcoexist, NORMAL_EXEC, 0xd8);
	halbtc8822b2ant_dec_bt_pwr(btcoexist, NORMAL_EXEC, 0);
...
void halbtc8822b2ant_action_wifi_multi_port(struct btc_coexist *btcoexist)
{
	halbtc8822b2ant_fw_dac_swing_lvl(btcoexist, NORMAL_EXEC, 0xd8);
	halbtc8822b2ant_dec_bt_pwr(btcoexist, NORMAL_EXEC, 0);
...
void halbtc8822b2ant_run_coexist_mechanism(struct btc_coexist *btcoexist)
{
	u8 algorithm = 0;
	...
	if (coex_sta->c2h_bt_inquiry_page) {
		BTC_PRINTF("[BTCoex], BT is under inquiry/page scan !!\n");
	...
	if (scan || link || roam) {
		BTC_PRINTF("[BTCoex], WiFi is under Link Process !!\n");
	...
	BTC_PRINTF("[BTCoex], Algorithm = %d\n", coex_dm->cur_algorithm);

	btcoexist->btc_get(btcoexist, BTC_GET_BL_WIFI_CONNECTED,
			   &wifi_connected);

	if (!wifi_connected) {
		BTC_PRINTF("[BTCoex], Action 2-Ant, wifi non-connected!!.\n");
		halbtc8822b2ant_action_wifi_nonconnected(btcoexist);
		   ...
		   (BT_8822B_2ANT_BT_STATUS_CONNECTED_IDLE ==
		    coex_dm->bt_status)) {
		BTC_PRINTF("[BTCoex], Action 2-Ant, bt idle!!.\n");
...
void halbtc8822b2ant_init_coex_dm(struct btc_coexist *btcoexist)
{
...
void halbtc8822b2ant_init_hw_config(struct btc_coexist *btcoexist,
				    bool wifi_only)
{
	u32 u32tmp1 = 0, u32tmp2 = 0, u32tmp3 = 0;
	u32 RTL97F_8822B = 0;
	...
	BTC_PRINTF("[BTCoex], 2Ant Init HW Config!!\n");
...
void ex_halbtc8822b2ant_scan_notify(struct btc_coexist *btcoexist, u8 type)
{
	...
	if (type == BTC_SCAN_START) {
		...
		BTC_PRINTF("[BTCoex], ********** SCAN START notify (2g)\n");
	...
	if (type == BTC_SCAN_START_2G) {
		...
		BTC_PRINTF("[BTCoex], SCAN FINISH notify  (Scan-AP = %d)\n",
			   coex_sta->scan_ap_num);
					  ...
					  u8 type)
{
	...
	if (type == BTC_SWITCH_TO_5G) {
		BTC_PRINTF("[BTCoex], switchband_notify ---  switch to 5G\n");
		...
		BTC_PRINTF("[BTCoex], switchband_notify ---  switch to 2G\n");
...
void ex_halbtc8822b2ant_connect_notify(struct btc_coexist *btcoexist, u8 type)
{
	...
	if ((type == BTC_ASSOCIATE_5G_START) ||
		...
		if (type == BTC_ASSOCIATE_5G_START)
			BTC_PRINTF("[BTCoex], connect_notify ---  5G start\n");
		else
			BTC_PRINTF("[BTCoex], connect_notify ---  5G finish\n");
	...
	if (type == BTC_ASSOCIATE_START) {
		...
		BTC_PRINTF("[BTCoex], CONNECT START notify (2G)\n");
		...
		*/
		...
		BTC_PRINTF("[BTCoex], CONNECT FINISH notify	(2G)\n");
					    ...
					    u8 type)
{
	...
	if (type == BTC_MEDIA_CONNECT) {
		BTC_PRINTF("[BTCoex], MEDIA connect notify\n");
		...
		BTC_PRINTF("[BTCoex], MEDIA disconnect notify\n");
					       ...
					       u8 type)
{
	...
	if (under_4way) {
		...
		coex_dm->arp_cnt++;
		BTC_PRINTF("[BTCoex], specific Packet ARP notify -cnt = %d\n",
			   coex_dm->arp_cnt);
				       ...
				       u8 *tmp_buf, u8 length)
{
	...
	BTC_PRINTF("[BTCoex], Bt_info[%d], len=%d, data=[", rsp_source, length);
