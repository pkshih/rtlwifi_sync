...
void halbtc8723b2ant_rf_shrink(struct btc_coexist *btcoexist, bool force_exec,
			       bool rx_rf_shrink_on)
{
...
void halbtc8723b2ant_set_dac_swing_reg(struct btc_coexist *btcoexist, u32 level)
{
	u8 val = (u8)level;
...
void halbtc8723b2ant_set_sw_full_time_dac_swing(struct btc_coexist *btcoexist,
...
void halbtc8723b2ant_dac_swing(struct btc_coexist *btcoexist, bool force_exec,
...
void halbtc8723b2ant_set_adc_back_off(struct btc_coexist *btcoexist,
				      bool adc_back_off)
{
	if (adc_back_off) {
		BTC_SPRINTF(trace_buf, BT_TMP_BUF_SIZE,
...
void halbtc8723b2ant_adc_back_off(struct btc_coexist *btcoexist,
...
void halbtc8723b2ant_agc_table(struct btc_coexist *btcoexist, bool force_exec,
			       bool agc_table_en)
{
...
void halbtc8723b2ant_set_coex_table(struct btc_coexist *btcoexist, u32 val0x6c0,
...
void halbtc8723b2ant_coex_table(struct btc_coexist *btcoexist, bool force_exec,
...
void halbtc8723b2ant_set_lps_rpwm(struct btc_coexist *btcoexist, u8 lps_val,
				  u8 rpwm_val)
{
	u8 lps = lps_val;
	u8 rpwm = rpwm_val;
...
void halbtc8723b2ant_lps_rpwm(struct btc_coexist *btcoexist, bool force_exec,
...
void halbtc8723b2ant_set_fw_pstdma(struct btc_coexist *btcoexist, u8 byte1,
...
void halbtc8723b2ant_power_save_state(struct btc_coexist *btcoexist, u8 ps_type,
				      u8 lps_val, u8 rpwm_val)
{
...
void halbtc8723b2ant_coex_all_off(struct btc_coexist *btcoexist)
{
	/* fw all off */
...
void halbtc8723b2ant_action_wifi_link_process(struct btc_coexist *btcoexist)
{
	u32 u32tmp;
	u8 u8tmpa, u8tmpb;
...
bool halbtc8723b2ant_action_wifi_idle_process(struct btc_coexist *btcoexist)
{
	static u8 prewifi_rssi_state = BTC_RSSI_STATE_LOW,
		  prewifi_rssi_state1 = BTC_RSSI_STATE_LOW;
	static u8 pre_bt_rssi_state = BTC_RSSI_STATE_LOW;
...
void halbtc8723b2ant_action_bt_whck_test(struct btc_coexist *btcoexist)
{
	halbtc8723b2ant_dec_bt_pwr(btcoexist, NORMAL_EXEC, 0);
...
void halbtc8723b2ant_wifi_off_hw_cfg(struct btc_coexist *btcoexist)
{
...
void halbtc8723b2ant_init_hw_config(struct btc_coexist *btcoexist, bool back_up)
{
	u8 u8tmp = 0;
	u32 vendor;
