...
struct tx_power_struct {
	u8 cck[RTL8822BE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER];
	u8 ht40_1s[RTL8822BE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER];
	u8 ht40_2s[RTL8822BE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER];
	u8 ht20_diff[RTL8822BE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER];
	u8 legacy_ht_diff[RTL8822BE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER];
	u8 legacy_ht_txpowerdiff;
	u8 groupht20[RTL8822BE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER];
	u8 groupht40[RTL8822BE_MAX_PATH_NUM][CHANNEL_MAX_NUMBER];
	u8 pwrgroup_cnt;
...
u32 rtl8822be_phy_query_bb_reg(struct ieee80211_hw *hw,
...
void rtl8822be_phy_get_txpower_level(struct ieee80211_hw *hw,
					 long *powerlevel);
void rtl8822be_phy_set_txpower_level(struct ieee80211_hw *hw,
						u8 channel);
void rtl8822be_phy_scan_operation_backup(struct ieee80211_hw *hw,
					     u8 operation);
...
void rtl8822be_phy_iq_calibrate(struct ieee80211_hw *hw,
					bool b_recovery);
void rtl8822be_phy_iq_calibrate(struct ieee80211_hw *hw,
					bool b_recovery);
...
#if 0
u32 phy_get_tx_bb_swing_8822B(struct ieee80211_hw *hw, u8 band, u8 rf_path);
#endif
